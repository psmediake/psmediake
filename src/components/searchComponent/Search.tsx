        ...
        <form onSubmit={handleSearch} className="relative">
          <div className="relative">
            <input
              ...
              onFocus={handleFocus}
              onBlur={handleBlur}
              placeholder="Search stories, news, topics..."
              className="w-64 pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0763fe] focus:border-transparent transition-all duration-200 placeholder-gray-400 shadow-lg"
            />
            <button
              type="submit"
            ...
            <form onSubmit={handleSearch} className="relative">
              <div className="relative">
                <input
                  ...
                  onChange={(e) => setQuery(e.target.value)}
                  placeholder="Search stories, news, topics..."
                  className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none  focus:border-transparent transition-all duration-200 placeholder-gray-400"
                  autoFocus
                />
                <button
                  type="submit"
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-[#0763fe] transition-colors duration-200"
                >
                  <BsSearch size={18} />
                </button>
                <button
